...
constexpr auto qt_meta_stringdata_CLASSAdminENDCLASS = QtMocHelpers::stringData(
    ...
    "on_pushButtonLoginUlang_clicked",
    "on_pushButtonTerima_clicked"
);
...
Q_CONSTINIT const QMetaObject Admin::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAdminENDCLASS_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_pushButtonLoginUlang_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_pushButtonTerima_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void Admin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_pushButtonCari_clicked(); break;
        case 3: _t->on_pushButtonDelete_clicked(); break;
        case 4: _t->on_pushButtonExit_clicked(); break;
        case 5: _t->on_pushButtonLoginUlang_clicked(); break;
        case 6: _t->on_pushButtonTerima_clicked(); break;
        default: ;
        }
    }
    (void)_a;
